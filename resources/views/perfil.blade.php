                ...
                <tr class="tr1">
                    <td class="td1">
                        <div class="card-body">
                            ...
                            <input class="card-text" type="text" name="name" placeholder="{{Auth::user()->name}}" size="20">
                    ...
                    <td class="td1">
                        <div class="card-body">
                            ...
                            <input class="card-text" type="email" name="email" placeholder="{{Auth::user()->email}}" size="30">
                    ...
                    <td class="td1">
                        <div class="card-body">
                            ...
                            <input class="card-text" type="password" name="password" size="20">
                ...
                <tr class="tr1">
                    <td class="td1">
                        <div class="card-body">
                            ...
                            <input class="card-text" type="text" name="morada" size="20" placeholder="{{$user->morada}}">
                        </div>
                    </td> 
                    ...
                    <td class="td1">
                        <div class="card-body">
                            ...
                            <input class="card-text" autocomplete="on" type="text" name="cod_postal" size="20" placeholder="{{$user->cod_postal}}">
                        </div>
                    </td> 
