                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form action="{{ route('categorias_adicionar') }}">
                                                    <h5>Adicionar Categoria</h5>
                                                    <input type="text"  name="adicionaCategoria"> <br> <br>
                                                    <button type="submit" class="btn btn-primary btn-edit">Adicionar</button>
                                                </form>
                                                <br>
                                                @if (session('error'))
                                                ...
                                                <form method="GET" action="{{ route('categorias_lista') }}">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-centered mb-0 align-middle table-hover table-nowrap">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="editable" contenteditable="false">{{ $categoria->categoria }}</td>
                                                                <td>
                                                                    <button type="button" class="btn btn-primary btn-edit" data-id="{{ $categoria->id }}">Editar</button> <br><br>
                                                                    @if ($categoria->id != 3) <!-- verifica se o id da categoria é diferente de 3 -->
        ...
        <script>
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    window.location.replace(`/admin/categorias/${categoriaId}`);
                });
            });
        </script>
