    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div>
                                                    <img src="../resources/images/megamenu-img.png" alt="megamenu-img" class="img-fluid mx-auto d-block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    <div class="mb-2">
                        <img src="../resources/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="layout-1">
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="../resources/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="layout-2">
                    </div>
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input theme-choice" type="checkbox" id="dark-mode-switch" data-bsStyle="../resources/css/bootstrap-dark.min.css" data-appStyle="../resources/css/app-dark.min.css">
                        <label class="form-check-label" for="dark-mode-switch">Dark Mode</label>
                    </div>
    
                    <div class="mb-2">
                        <img src="../resources/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="layout-3">
                    </div>
                    <div class="form-check form-switch mb-5">
                        <input class="form-check-input theme-choice" type="checkbox" id="rtl-mode-switch" data-appStyle="../resources/css/app-rtl.min.css">
