...
<head>
  ...
  <link href="../resources/css/now-ui-dashboard.css?v=1.3.0" rel="stylesheet" />
...
<body class="sidebar-mini clickup-chrome-ext_installed">
  <noscript>
    <images height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=111649226022273&ev=PageView&noscript=1" />
  </noscript>
...
<nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
              ...
              <tbody>
                    ...
                    <td>
                      <span class="avatar avatar-sm rounded-circle">
                        <images src="{{asset('resources')}}/images/default-avatar.png" alt="" style="max-width: 80px; border-radiu: 100px">
                      </span>
                    </td>
                    <td>Admin</td>
  ...
  <script src="{{ asset('resources') }}/js/now-ui-dashboard.min.js?v=1.3.0" type="text/javascript"></script>
